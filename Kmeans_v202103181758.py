...
def Generar_Clusters(texts, clusters):
    ...
    print("Iniciando Clustering con %s" % km_model)
    t0 = time()
...
def GenerarCorpus(nombreArchivoEntrada):
    ...
    textos = [posteos[i][1].strip() for i in range(datasetCSV.init, datasetCSV.end)]
...
if __name__ == "__main__":
    ...
    cant_clusters = 14
    clusters = Generar_Clusters(corpus_limpio, cant_clusters)
